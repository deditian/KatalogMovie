...
public class FavoriteWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.example.root.sub_katalog_dedi.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.root.sub_katalog_dedi.EXTRA_ITEM";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setPendingIntentTemplate(R.id.stackview_favorite
                , toastPendingIntent);
